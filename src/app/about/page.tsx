    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-green-50 to-white text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 flex flex-col items-center text-center">
          <Reveal width="100%">
            <span className="text-green-600 font-semibold tracking-wider uppercase text-sm mb-4 block">Get to Know Us</span>
      ...
      <section className="py-24 bg-slate-50">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Reveal>
              <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-200 h-full hover:shadow-lg transition-shadow flex flex-col items-center text-center">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        {/* Background glow */}
        <div className="absolute -left-1/4 top-0 w-1/2 h-full bg-green-600/10 blur-[120px] rounded-full pointer-events-none" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((val, index) => (
              <Reveal key={val.num} delay={index * 0.1} className="h-full">
                <div className="bg-slate-50 backdrop-blur-md p-8 rounded-2xl border border-slate-200 h-full text-center group hover:border-green-500/50 transition-colors flex flex-col items-center">
                  <div className="text-4xl font-heading font-black bg-gradient-to-b from-green-400 to-green-600 text-transparent bg-clip-text mb-4 opacity-50 group-hover:opacity-100 transition-opacity">
                    {val.num}
                  </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative flex justify-center">
              <Reveal>
                <div className="relative w-72 h-72 md:w-96 md:h-96">
                  {/* Blob Background */}
                  <div className="absolute inset-0 bg-gradient-to-tr from-green-500 to-teal-400 rounded-[60%_40%_30%_70%/60%_30%_70%_40%] animate-[morphing_12s_infinite_alternate_ease-in-out] shadow-2xl shadow-green-500/30 flex items-center justify-center flex-col text-slate-900">
            ...
            <div className="order-1 lg:order-2 flex flex-col items-center text-center lg:items-start lg:text-left">
              <Reveal width="100%">
                <span className="text-green-600 font-semibold tracking-wider uppercase text-sm mb-4 block">Local Roots, Global Reach</span>
